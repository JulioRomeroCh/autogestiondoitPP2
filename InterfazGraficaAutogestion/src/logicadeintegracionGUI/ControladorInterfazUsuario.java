package logicadeintegracionGUI;
...
import logicadepresentacion.InterfazUsuario;

public class ControladorInterfazUsuario implements ActionListener {
  
  //-------------------------ATRIBUTOS-------------------------
  private logicadepresentacion.InterfazUsuario vistaGUI = new InterfazUsuario();  
  ...
  //-------------------------LLAMADO DE MÉTODOS-------------------------
  public static String llamarMetodoRegistrarCliente(String pIdentificacion, String pNombre,  String pPrimerApellido, String pSegundoApellido,
