...
public class Cuenta implements Comparable {
  ...
  public String depositarDolares(ITipoCambio pCompra, String pNumeroCuenta, int pMonto){     
    DecimalFormat formatoDosDecimales = new DecimalFormat("#.00"); 
  ...
  public String retirarDolares(ITipoCambio pVenta, String pNumeroCuenta, String pPin, int pMonto){
  ...
  public String consultarSaldoDolares(ITipoCambio pCompra, String pNumeroCuenta, String pPin){     
    registrarOperacion(TipoOperacion.CONSULTA, pNumeroCuenta, false,  0, 0.0);       
    DecimalFormat formatoDosDecimales = new DecimalFormat("#.00");      
